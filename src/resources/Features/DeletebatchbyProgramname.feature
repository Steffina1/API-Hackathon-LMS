...
Feature: To test the program using DELETE
   ...
   Given User sends base URL to delete "PostgreSQL991".
   When User sends request with valid program name.
   Then User status code '200 ok'.
   ...
   Then User checks response if status code is '404 Not Found'
   ...
   Then Verify response with '400 Bad Request'
