Feature: To test the batch using DELETE
  ...
  Scenario: User able to delete a Batch by ID with valid request.
    Given User sends base url to delete <5087>.
    ...
    Then Verify if the response  status code is ' 405 Method Not Allowed'
